...
$sql = "SELECT * FROM med_data2 WHERE address LIKE '%" . $_POST['name'] . "%'";
...
?>
        ...
        <div class="contain">
            <div class="result-product">
                ...
                ?>
                <div style="margin-left: 5%; display: flex; justify-content: center; align-items: center;">
                    <div>
                ...
                <div class="button-field">
                    ...
                    <a href="shop_details.php?name=<?php echo $row['med_shop']; ?>&address=<?php echo $row['address']; ?>&contact=<?php echo $row['contact']; ?>&location=<?php echo $row['location']; ?>&opentime=<?php echo $row['opening-time']; ?>&closetime=<?php echo $row['closing-time']; ?>&contact=<?php echo $row['contact']; ?>&google_maps=<?php echo $row['google-map']; ?>">
                        <button type="submit" name="explore-store" value="<?php echo $row['med_shop'] ?>" class="btn btn-primary" style="background-color: #5fd37e; border: none; color: black; padding: 10px 20px 10px 20px; margin-left: 35%; border-radius:10px;"><b>Explore Store</b></button>                       
                    </a>
            ...
            <div class="result-product-foot">
                ...
                <div class="button-field">
                    <a href="tel:<?php echo $row['contact']?>"><button type="button" class="btn btn-primary" style="background-color: #5fd37e; border: none; color: black; padding: 10px 20px 10px 20px; border-radius:10px; margin-right:1rem;"><b>Contact</b></button></a>
                    <a href="<?php echo $row['google-map']?>"><button type="button" class="btn btn-primary" style="background-color: #5fd37e; border: none; color: black; padding: 10px 20px 10px 20px; border-radius:10px;"><b>Google Maps</b></button></a>
